...
public static partial class StringExtensions {
    ...
    extension(string? str) {
        ...
        /// <returns></returns>
        public bool? ToBoolean(bool strict) {
            return strict
        ...
        /// </summary>
        public bool? ToBoolean(string? trueString, string? falseString) {
            if (str is null) {
                if (falseString is null) { return false; }
                if (trueString is null) { return true; }
            }
            else {
        ...
        /// </summary>
        public bool? ToBoolean(
            IEnumerable<string?> trueStrings, IEnumerable<string?> falseStrings) {
            // str 为 null 时优先判定 false 值
            if (str is null && falseStrings.Any(v => v is null)) { return false; }
        ...
        /// </summary>
        public bool? ToBoolean(Func<string?, bool?> predicator) => predicator(str);
